...
/**
 * CallTier represents which tier of the five-tier call handling architecture
 * matched this call. Set by CallScreeningEngine, consumed by CallScreeningService
...
data class CallInfo(
    ...
    val callDecision: SignalGateCallScreeningService.CallDecision,
    val tier: CallTier
) : Parcelable
