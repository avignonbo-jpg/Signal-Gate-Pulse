...
[ ] Investigate MainApplication.onCreate() main-thread Keystore/SQLCipher StrictMode reads and startup jank; any off-main initialization must preserve Architecture-Contract §2's required-source seeding guarantee before call-screening bindings resolve.
[ ] Measure the FCC export byte count against SnapshotSanityValidator's 25 MiB limit after the 50,000-row sync rejection; adjust source/query or limit only from measured evidence.
